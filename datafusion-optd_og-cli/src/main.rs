...
use datafusion_optd_og_cli::catalog::DynamicObjectStoreCatalog;
use datafusion_optd_og_cli::functions::ParquetMetadataFunc;
use datafusion_optd_og_cli::{
    exec,
    pool_type::PoolType,
...
struct Args {
    ...
    #[clap(long, help = "Turn on datafusion logical optimizer before optd_og")]
...
async fn main_inner() -> Result<()> {
    ...
    let ctx = optd_og_datafusion_bridge::create_df_context(
