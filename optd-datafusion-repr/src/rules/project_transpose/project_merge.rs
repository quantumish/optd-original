...
mod tests {
    ...
    fn proj_merge_basic() {
        ...
        let top_proj_exprs = ExprList::new(
            vec![
        ...
        let bot_proj_exprs = ExprList::new(
            vec![
                ColumnRefExpr::new(2).into_expr(), 
                ColumnRefExpr::new(0).into_expr(),
        ...
        let res_proj_exprs = ExprList::new(
            vec![
                ColumnRefExpr::new(4).into_expr(), 
                ColumnRefExpr::new(2).into_expr(),
            ]
