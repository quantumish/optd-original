...
use datafusion_optd_og_cli::exec::{exec_from_commands, exec_from_commands_collect, exec_from_files};
...
async fn main() -> Result<()> {
    ...
    exec_from_files(
        &ctx,
        vec!["datafusion-optd_og-cli/tpch-sf0_01/populate.sql".to_string()],
